...
{#if style === 'wave'}
  <svg width={size} height={size} viewBox="0 0 120 120">
    ...
    <g clip-path="url(#bubbleClip1)">
      <path d="M 0 60 Q 15 50, 30 60 T 60 60 T 90 60 T 120 60" fill="none" stroke="#60A5FA" stroke-width="2" opacity="0.8">
      ...
      <path d="M 0 50 Q 15 40, 30 50 T 60 50 T 90 50 T 120 50" fill="none" stroke="#3B82F6" stroke-width="2" opacity="0.6">
        <animate attributeName="d"
      ...
      <path d="M 0 70 Q 15 60, 30 70 T 60 70 T 90 70 T 120 70" fill="none" stroke="#60A5FA" stroke-width="2" opacity="0.6">
        <animate attributeName="d"
    ...
    <circle cx="60" cy="60" r="50" fill="none" stroke="#60A5FA" stroke-width="2" opacity="0.5" />
  </svg>
...
{:else if style === 'spin'}
  <svg width={size} height={size} viewBox="0 0 120 120">
    ...
    <circle cx="60" cy="60" r="50" fill="none" stroke="#8B5CF6" stroke-width="2" opacity="0.5" />
  </svg>
...
{:else if style === 'pulse'}
  <svg width={size} height={size} viewBox="0 0 120 120">
    ...
    <circle cx="60" cy="60" r="35" fill="none" stroke="#F472B6" stroke-width="2" opacity="0.6">
      <animate attributeName="r" values="35;42;35" dur="1.8s" repeatCount="indefinite" />
      <animate attributeName="opacity" values="0.6;0.1;0.6" dur="1.8s" repeatCount="indefinite" />
    </circle>

    <circle cx="60" cy="60" r="28" fill="none" stroke="#EC4899" stroke-width="2" opacity="0.5">
    ...
    <circle cx="60" cy="60" r="40" fill="none" stroke="#BE185D" stroke-width="3" opacity="0.4">
    ...
    <circle cx="60" cy="60" r="20" fill="none" stroke="#F472B6" stroke-width="1.5" opacity="0.7">
    ...
    <circle cx="60" cy="60" r="50" fill="none" stroke="#EC4899" stroke-width="2" opacity="0.5" />
  </svg>
...
{:else if style === 'blink'}
  <svg width={size} height={size} viewBox="0 0 120 120">
    ...
    <circle cx="60" cy="60" r="50" fill="none" stroke="#F59E0B" stroke-width="2" opacity="0.5" />
  </svg>
...
{:else if style === 'rings'}
  <svg width={size} height={size} viewBox="0 0 120 120">
    ...
    <g transform-origin="60 60">
      <ellipse cx="60" cy="60" rx="40" ry="15" fill="none" stroke="#10B981" stroke-width="2" opacity="0.7">
        <animateTransform attributeName="transform" type="rotate"
    ...
    <g transform-origin="60 60">
      <ellipse cx="60" cy="60" rx="40" ry="15" fill="none" stroke="#34D399" stroke-width="2" opacity="0.7">
        <animateTransform attributeName="transform" type="rotate"
    ...
    <circle cx="60" cy="60" r="50" fill="none" stroke="#10B981" stroke-width="2" opacity="0.5" />
  </svg>
  ...
  <svg width={size} height={size} viewBox="0 0 120 120">
    <defs>
      ...
      <linearGradient id="matrixGradient" x1="0%" y1="0%" x2="0%" y2="100%">
        <stop offset="0%" stop-color="#10B981" opacity="0.1" />
        <stop offset="50%" stop-color="#10B981" opacity="0.8" />
        <stop offset="100%" stop-color="#10B981" opacity="0.2" />
      </linearGradient>
    </defs>
    ...
    <g clip-path="url(#matrixClip)">
      <text x="18" y="0" fill="url(#matrixGradient)" font-size="9" font-family="monospace" opacity="0.9">
      ...
      <text x="28" y="-30" fill="#10B981" font-size="9" font-family="monospace" opacity="0.7">
      ...
      <text x="38" y="-50" fill="#34D399" font-size="9" font-family="monospace" opacity="0.8">
      ...
      <text x="48" y="-20" fill="#10B981" font-size="9" font-family="monospace" opacity="0.6">
      ...
      <text x="58" y="-40" fill="#34D399" font-size="9" font-family="monospace" opacity="0.7">
      ...
      <text x="68" y="-15" fill="#10B981" font-size="9" font-family="monospace" opacity="0.8">
      ...
      <text x="78" y="-35" fill="#34D399" font-size="9" font-family="monospace" opacity="0.6">
      ...
      <text x="88" y="-25" fill="#10B981" font-size="9" font-family="monospace" opacity="0.7">
      ...
      <text x="98" y="-45" fill="#34D399" font-size="9" font-family="monospace" opacity="0.8">
...
{:else if style === 'morph'}
  <svg width={size} height={size} viewBox="0 0 120 120">
    ...
    <circle cx="60" cy="60" r="50" fill="none" stroke="url(#multiGradient)" stroke-width="2" opacity="0.6">
...
{:else if style === 'icon'}
  <svg width={size} height={size} viewBox="0 0 120 120">
    ...
    <g transform="translate(60, 60) scale(1.75)">
      <circle cx="0" cy="0" r="14" fill="url(#iconCoreGradient)" />

      <g>
        <path d="M -5 2 L -6 4 L 6 4 L 5 2 Z" fill="url(#iconCrownGradient)" />
        <path d="M -5 2 L -4 -4 L -3 2 M -1 2 L 0 -5 L 1 2 M 3 2 L 4 -4 L 5 2" fill="url(#iconCrownGradient)" />
      </g>
    </g>
